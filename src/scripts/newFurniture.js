...
document.addEventListener('DOMContentLoaded', () => {
  // Event for start content Created product-box.
  fadeAnimation();
  dotsSetter();
  filler();
...
tabs.forEach(elem => {
  // Added Event  which created content/product-box for every category tab
...
function dotsSetter () {
  for (let i = 3; i >= 0; i--) {
    // Return inteneger of products witch will be visiable dependent devices' width.
